...
- sentence-transformers embedder embeds in batches of 32
...
def ingest_corpus(
    ...
    embedder = OllamaEmbedder(model=settings.embed_model, batch_size=batch_size)
    ...
    print(f"🧠 Generating embeddings with {settings.embed_model} (batch_size=32)...")
