...
def render_score_hud(
    ...
    <div class="score-container">
        <div class="score-card" title="Overall Code Quality Score out of 10">
            <div class="score-val" style="color: {grade_color};">{quality_ten} <span style="font-size: 1.05rem; font-weight: 500; color: #94A3B8;">/10</span></div>
            <div class="score-lbl">🛡️ Quality Score ({safe_grade})</div>
        </div>
